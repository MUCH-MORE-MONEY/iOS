//
//  StatisticsSkeletonTableViewCell.swift
//  MMM
//
...
final class StatisticsSkeletonTableViewCell: BaseTableViewCell {
	// MARK: - Constants
	private enum UI {
	...
	override func layoutSubviews() {
		...
		starLayer.frame = starImageView.bounds
		starLayer.cornerRadius = starImageView.bounds.height / 2
	}
}
//MARK: - Action
extension StatisticsSkeletonTableViewCell {
}
//MARK: - Attribute & Hierarchy & Layouts
extension StatisticsSkeletonTableViewCell: SkeletonLoadable {
	// 초기 셋업할 코드들
	override func setAttribute() {
		...
		starLayer = starLayer.then {
			...
			$0.add(titleGroup, forKey: "backgroundColor")
		}
