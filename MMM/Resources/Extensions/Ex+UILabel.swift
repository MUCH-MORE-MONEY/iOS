...
//  MMM
//
//  Created by Park Jungwoo on 2023/05/26.
//
...
extension UILabel {
    ...
    func gesturePublisher1(_ gestureType: GestureType = .tap()) ->
    GesturePublisher {
    ...
    struct GesturePublisher: Publisher {
        ...
        init(view: UILabel, gestureType: GestureType) {
            self.view = view
    ...
    class GestureSubscription<S: Subscriber, V: UILabel>: Subscription where S.Input == GestureType, S.Failure == Never {
